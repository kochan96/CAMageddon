...
{
	class BSplinePatch : public SurfaceUV
	{
	public:
		...
		static std::shared_ptr<BSplinePatch> CreateRectPatch(
			std::string name,
		...
		static std::shared_ptr<BSplinePatch> CreateCyliderPatch(
			std::string name,
			glm::vec3 center,
			int PatchCountx,
			int PatchCounty,
		...
		static std::shared_ptr<BSplinePatch> CreateBSplinePatch(
			std::string name,
