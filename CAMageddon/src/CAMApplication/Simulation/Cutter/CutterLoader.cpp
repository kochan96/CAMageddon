...
//	};
//
//	Scope<Cutter> CutterLoader::Load(std::filesystem::path filePath)
//	{
//		auto cutterType = GetCutterType(filePath);
//		auto diameter = GetDiameter(filePath);
//		auto instructions = GetInstructions(filePath);
//
//		return CreateScope<Cutter>(instructions);
//	}
//
//	float CutterLoader::GetDiameter(std::filesystem::path filePath)
//	{
//		auto diameter = filePath.extension().string().substr(1);
//		return atof(diameter.c_str());
//	}
//
//	CutterType CutterLoader::GetCutterType(std::filesystem::path filePath)
//	{
//		auto extension = filePath.extension().string();
//		return extension[0] == 'k' ? CutterType::SPHERICAL : CutterType::FLAT;
//	}
//
//	std::vector<Instruction> CutterLoader::GetInstructions(std::filesystem::path filePath)
//	{
...
//	}
//
//	Instruction CutterLoader::GetInstruction(std::string rawInstruction, glm::vec3& lastPosition)
//	{
//		int id;
